...
public class PhotoTask implements
    ...
    // Implements TaskRunnableDownloadMethods.getByteBuffer and TaskRunnableDecodeMethods.getByteBuffer
    @Override
    ...
    // Implements TaskRunnableDecodeMethods.getTargetWidth. Returns the global target width.
    @Override
    public int getTargetWidth() {
        return mTargetWidth;
    }

    // Implements TaskRunnableDecodeMethods.getTargetHeight. Returns the global target height.
    @Override
    ...
    // Implements TaskRunnableDownloadMethods.getImageURL. Returns the global Image URL.
    @Override
    public URL getImageURL() {
        return mImageURL;
    }

    // Implements TaskRunnableDownloadMethods.setByteBuffer. Sets the image buffer to a buffer object.
    @Override
    ...
    // Implements TaskRunnableDecodeMethods.setImage(). Sets the Bitmap for the current image.
    @Override
    public void setImage(Bitmap decodedImage) {
        mDecodedImage = decodedImage;
    }

    // Implements TaskRunnableDownloadMethods.setDownloadThread(). Calls setCurrentThread().
    @Override
    ...
    /*
     * Implements TaskRunnableDownloadMethods.handleHTTPState(). Passes the download state to the
     * ThreadPool object.
     */
    @Override
    ...
    // Implements TaskRunnableDecodeMethods.setImageDecodeThread(). Calls setCurrentThread().
    @Override
    ...
    /*
     * Implements TaskRunnableDecodeMethods.handleDecodeState(). Passes the decoding state to the
     * ThreadPool object.
     */
    @Override
