...
public class RSSPullService extends IntentService {
    ...
    protected void onHandleIntent(Intent workIntent) {
        ...
        /*
         * A block that tries to connect to the Picasa web album URL passed as the "data"
        ...
        try {
            ...
            if ((localURLConnection instanceof HttpURLConnection)) {
                ...
                if (null != cursor && cursor.moveToFirst()) {
                    ...
                    /*
                     * Always retrieve pictures from the remote sites
                     */
                    if (0 != storedModifiedDate && false) {
                    ...
                    /*
                     * No modification date was found for the URL, so new metadata has to be
                     * retrieved.
                     */
